...
Your project has two registration views:
1. `apps/users/views.py` - Contains actual registration logic
2. `apps/users/web/views.py` - Simple placeholder view

**Check which URL is being used:**

Edit `apps/users/web_urls.py` and ensure it uses the correct view:

```python
from . import views  # Use this for the view with registration logic
...
**NOT this:**
```python
from .web import views  # This has placeholder view only
